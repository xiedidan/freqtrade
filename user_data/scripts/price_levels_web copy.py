...
def get_available_pairs(usdt_only: bool = False, spot_only: bool = False, include_existing: bool = True) -> List[str]:
    ...
    try:
        ...
        try:
            ...
            # Add filtered markets to pairs list
        ...
        if 'proxy' in error_msg.lower() or 'timeout' in error_msg.lower() or 'connection' in error_msg.lower():
            ...
            pairs.append("ERROR_PROXY_CONNECTION")
...
def check_inactive_pairs() -> Dict[str, bool]:
    ...
    try:
        ...
        active_pairs = set(get_available_pairs(spot_only=True))
...
def add_level():
    ...
    try:
        ...
        result = ATRLevelSignal.add_price_level(pair, level, direction)
                    ...
                    <div class="card-body">
                        <form id="addLevelForm">
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    <button type="button" id="testProxyBtn" class="btn btn-sm btn-outline-warning w-100">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            `;
                            ...
                            // 显示结果
                            pairsAlert.innerHTML = resultHtml;
